...
firstOptionLCD lcd1("Goal 1", 3, 0, 0x27, 2);
firstOptionLCD lcd2("Goal 2", 2, 6, 0x26, 3);
secondOptionLCD lcd3("Goal 3", 6, 4, 0x25, 4);
firstOptionLCD lcd4("Goal 4", 6, 3, 0x24, 5);
firstOptionLCD lcd5("Goal 5", 4, 4, 0x23, 6);
