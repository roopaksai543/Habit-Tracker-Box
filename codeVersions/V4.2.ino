...
class lcdDisplay {
  ...
  // Constructor
  lcdDisplay(String goalName_, int goalDay1_, int goalDay2_, int rsPin_, int enPin_, int d4Pin_, int d5Pin_, int d6Pin_, int d7Pin_, int buttonPin_) : lcd(rsPin_, enPin_, d4Pin_, d5Pin_, d6Pin_, d7Pin_) {
    goalName = goalName_;
    goalDay1 = goalDay1_;
    goalDay2 = goalDay2_;
    rsPin = rsPin_;
...
lcdDisplay lcd1("Goal 1", 4, 7, 8, 9, 10, 11, 12, 13, A0);
lcdDisplay lcd2("Goal 2", 5, 1, 2, 3, 4, 5, 6, 7, A1);
...
void setup() {
  ...
  setTime(23, 59, 50, 9, 7, 2025); // (Hour - 24H, Minute, Second, Day, Month, Year)
